// Crear conductor con RUT chileno válido
...
async function createDriverValidRut() {
  console.log('👤 CREANDO CONDUCTOR CON RUT VÁLIDO\n');
  ...
  // 3. Crear conductor con RUT válido (11.111.111-1 es un RUT de ejemplo válido)
  const driverData = {
    fullName: 'Conductor de Prueba',
    email: 'conductor.prueba@demo.com',
    phone: '+56912345678',
    taxId: '11.111.111-1', // RUT chileno válido (ejemplo)
  ...
  console.log('\n🔧 CREANDO CONDUCTOR CON RUT VÁLIDO:');
