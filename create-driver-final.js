// Crear conductor con RUT válido y único - versión final
...
async function createDriverFinal() {
  console.log('👤 CREANDO CONDUCTOR FINAL - ACCESO FUNCIONAL\n');
  ...
  // 3. Crear conductor con RUT único (33.333.333-3)
  const driverData = {
